 ...
 create table Product(maker char(20), model char(20) primary key, type char(20) not null);
 
 create table PC(model char(20) primary key, foreign key (model) references product (model) on delete cascade, speed decimal(3,2), ram int, hd int, price decimal(8,2));
 
 create table Laptop(model char(20) primary key, foreign key (model) references product (model) on delete cascade, speed decimal(4,2), ram int, hd int, screen decimal(3,1), price decimal(8,2));
 
 create table Printer(model char(20) primary key, foreign key (model) references product (model) on delete cascade, color boolean, type char(10), price decimal(8,2));
